	...
	if (isset($_POST)){
		if ($_POST['num1'] + $_POST['num2'] == $_POST['math_challenge_answer']){
			...
			$message2 = '
				...
				<p><span style="font-size:1.5em;">T</span>hank you for signing up to ULife Test Review Seminar. Your seat and study packages have been reserved.</p>

				<p>Note: Seats are limited and first-come-first-served. Please kindly attend the session on time as seats will be reserved till the start of the session only and we will free up the seats for students on waiting list afterwards. </p>
			...
			mail($_POST['email'], "ULife Academics New Registration Confirmation", $message2, $headers );			
