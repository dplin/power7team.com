...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {	
        $this->options = array(
            'script_url' => $this->get_full_url().'/admin/server',
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/views/admin/server/files/',
            'upload_url' => $this->get_full_url().'/views/admin/server/files/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
